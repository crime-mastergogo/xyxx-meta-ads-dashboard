...
.static-preview{{height:900px;}}
.static-preview iframe{{border:none;width:100%;height:900px;display:block;overflow:hidden;}}
.no-prev{{height:900px;display:flex;align-items:center;justify-content:center;color:#333;font-size:10px;}}
